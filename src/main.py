    ...
    if mqtt_client:
        ...
        while True:
            try:
                ...
                # KORREKTUR 1: Nur senden, wenn Client existiert
                if mqtt_client:
                    # Publish the data
                    ...
                    # Wenn kein Client da ist (letzter Reconnect failed), Fehler auslösen
                    # um direkt zum 'except'-Block zu springen.
                    raise OSError("MQTT Client is None, attempting reconnect.")

            except OSError as e:
                print(f"Verbindungsfehler: {e}. Versuche Neuverbindung...")

                # KORREKTUR 2: Nur trennen, wenn Client existiert
                if mqtt_client:
                ...
                # Wenn Neuverbindung fehlschlägt, kurz warten, um Dauerschleife zu verhindern
                if not mqtt_client:
                    print("Neuverbindung fehlgeschlagen, warte 5s...")
                    time.sleep(5)
